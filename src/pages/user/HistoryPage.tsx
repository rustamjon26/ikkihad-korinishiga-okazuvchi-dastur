    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Button
            variant="outline"
            onClick={() => toast.info("PDF generatsiya qilinmoqda...")}
          >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Barcha saqlangan konvertatsiyalaringiz ro'yxati
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <div className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex gap-2 shrink-0">
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => toast.info("Batafsil koʻrish")}
                          >
